...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("Min date for booking")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get bookings missing hotel.")]
    ...
    [KernelFunction]
    [Description("Get bookings with multiple hotels.")]
